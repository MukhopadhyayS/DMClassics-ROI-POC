...
*/
public class TestRequestDetailReportDAOImpl
extends BaseROITestCase {
    ...
    /**
     * Test case to generate request detail report with valid input
     */
    ...
    /**
     * Test case to generate request detail report with invalid from date
     */
    public void testReportWithInvalidFromDate() {
        ...
        try {
            ...
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Request Detail Report should have failed");
    ...
    /**
     * Test case to generate request detail report with from date as null
     */
    public void testReportWithNullFromDate() {

        try {
            String url = constructURLString("Patient", "Logged", null, "10/14/2008", "5", facilities, "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Request Detail Report should have failed");
    ...
    /**
     * Test case to generate request detail report with to date as null
     */
    public void testReportWithNullToDate() {

        try {
            String url = constructURLString("Patient", "Logged", "10/14/2008", null, "5", facilities, "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Request Detail Report should have failed");
    ...
    /**
     * Test case to generate request detail report with invalid report id
     */
    ...
    /**
     * Test case to generate request detail report without status
     */
    ...
    /**
     * Test case to generate request detail report without from date
     */
    ...
    /**
     * Test case to generate request detail report without to date
     */
