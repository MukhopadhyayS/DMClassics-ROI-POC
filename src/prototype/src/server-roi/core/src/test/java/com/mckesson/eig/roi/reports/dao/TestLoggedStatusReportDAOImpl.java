...
*/
public class TestLoggedStatusReportDAOImpl
extends BaseROITestCase {
    ...
    public void testReportWithNullRequestorTypes() {
        ...
        try {
            String url = constructURLString(null, "10/13/2007", "10/14/2009", "8", facilities, "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            assertNotNull("Response was null", response);
    ...
    public void testReportWithInvalidFromDate() {
        ...
        try {
            String url = constructURLString("Patient", "invalidDate", "10/14/2008", "8", facilities, "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
    ...
    public void testReportWithNullFromDate() {
        ...
        try {
            String url = constructURLString("Patient", null, "10/14/2008", "8", facilities, "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Logged Status Report should have failed");
    ...
    /**
     * Test case to generate logged status report with to date as null
     */
    ...
    public void testReportWithInvalidReportId() {
        ...
        try {
            String url = constructURLString("Patient", "10/14/2008", "10/14/2008", "100", facilities, "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Logged Status Report should have failed");
    ...
    public void testReportWithoutRequestorTypes() {
        ...
        try {
            String url = constructURLStringWithoutReqTypes("10/13/2008", "10/14/2008", "8", "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            assertNotNull("Response was null", response);
    ...
    public void testReportWithoutToDate() {
        ...
        try {
            String url = constructURLStringWithoutToDt("Patient", "10/14/2008", "8", "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Logged Status Report should have failed");
