 ...
 */
public class TestPostedPaymentsSummaryReportDAOImpl
extends BaseROITestCase {
    ...
    /**
     * Test case to generate posted payments summary report with invalid from date
     */
    public void testReportWithInvalidFromDate() {
        ...
        try {
            ...
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate posted payments summary Report should have failed");
    ...
    /**
     * Test case to generate posted payments summary  report with from date as null
     */
    ...
    /**
     * Test case to generate posted payments summary  report with to date as null
     */
    ...
    /**
     * Test case to generate posted payments summary  report with invalid report id
     */
    ...
    /**
     * Test case to generate posted payments summary report without status
     */
    ...
    /**
     * Test case to generate posted payments summary  report without from date
     */
    public void testReportWithoutFromDate() {

        try {
            String url = constructURLStringWithoutFromDt("Logged",
                                                         "IE",
                                                         "10/14/2008",
                                                         "10",
                                                         "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Oposted payments summary  Report should have failed");
    ...
    /**
     * Test case to generate posted payments summary  report without to date
     */
    public void testReportWithoutToDate() {

        try {
            String url = constructURLStringWithoutToDt("Logged",
                                                       "IE",
                                                       "10/14/2008",
                                                       "10",
                                                       "1");
    ...
    protected String constructURLStringWithoutFromDt(String status,
                                                     String facilities,
                                                     String toDt,
                                                     String reportId,
                                                     String userInstanceId) {
    ...
    protected String constructURLStringWithoutToDt(String status,
                                                   String facilities,
                                                   String fromDt,
                                                   String reportId,
                                                   String userInstanceId) {
