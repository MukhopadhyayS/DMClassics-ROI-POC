...
*/
public class LoggedStatusReportDAOImpl
extends ROIReportDAOImpl {


    private static final Log LOG = LogFactory.getLogger(LoggedStatusReportDAOImpl.class);
    ...
    private static final int PATIENT_NAME_POSITION = 5;
    private static final int ENCOUNTER_ID_POSITION = 6;
    private static final int ADMIT_DATE_POSITION = 7;
    private static final int PATIENT_TYPE_POSITION = 8;
    private static final int IS_VIP = 9;
    private static final int IS_LOCKED = 10;
    ...
    public void generateReport(String reportID, Map params,
        ...
        try {
            ...
            List<Object[]> results = processNamedQuery("Generate_LoggedStatusReport", criterias);
            ...
            throw new IOException("Requests with Logged Status report generation failed");
        }
    }
    ...
    private void generateCSV(List<Object[]> results, PrintStream out, String headers) {
        ...
        for (Object[] result : results) {
            ...
            String csvData = new StringBuffer()
                             ...
                             .append(CSV_DELIM)
                             .append(ROIReportUtil.getDateTimeCsv(result, ADMIT_DATE_POSITION))
                             .append(CSV_DELIM)
    ...
    private String getHeaders() {
        ...
        return new StringBuffer()
               ...
               .append("Date Created,Request Id,Facility,")
               .append("Patient Name,Encounter Id,")
               .append("Admit Date,Patient Type,Vip Patient,Locked Patient")
       .toString();
    }
}
