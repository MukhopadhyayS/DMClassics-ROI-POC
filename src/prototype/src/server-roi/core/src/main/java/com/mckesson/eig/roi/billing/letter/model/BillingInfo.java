...
public class BillingInfo {
    ...
    public List<Charge> getCharges() { return _charges; }
    public void setCharges(List<Charge> charges) { _charges = charges; }

    public ShippingInfo getShippingInfo() { return _shippingInfo; }
    public void setShippingInfo(ShippingInfo info) { _shippingInfo = info; }
}
