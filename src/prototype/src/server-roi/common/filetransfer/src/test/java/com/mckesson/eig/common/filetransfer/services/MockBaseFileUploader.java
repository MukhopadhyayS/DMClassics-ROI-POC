 ...
 */
public class MockBaseFileUploader extends BaseFileUploader {
    ...
    protected int writeFileBuffered(BaseFileTransferData data,
                             ...
                             boolean boolAppend) {
        try {
            super.writeFileBuffered(data, inputStream, strDirPath, "", dataLength, boolAppend);
            return SUCCESS;
        } catch (Exception e) {
    ...
    /**
     * @see com.mckesson.eig.common.filetransfer.services.BaseFileUploader#getFileName()
     */
    @Override
