...
public class ConcurrencyInterruptedException extends ConcurrencyException {
     ...
     */
    public ConcurrencyInterruptedException() {
        super();
    }
     ...
     *            Exception message
     */
    public ConcurrencyInterruptedException(String message) {
        super(message);
    }
     ...
     */
    public ConcurrencyInterruptedException(Throwable cause) {
        super(cause);
    }
     ...
     *            the exception we are cascading
     */
    public ConcurrencyInterruptedException(String message, Throwable cause) {
        super(message, cause);
    }
}
