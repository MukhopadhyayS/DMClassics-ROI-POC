 ...
 * 
 */
public class TestJndiNameAlreadyExistsException
        extends
     ...
     * @param arg0
     */
    public TestJndiNameAlreadyExistsException(String arg0) {
        super(arg0);
    }

    public static Test suite() {
        return new CoverageSuite(TestJndiNameAlreadyExistsException.class,
                JndiNameAlreadyExistsException.class);
    }

    public ApplicationException createException() {
        return new JndiNameAlreadyExistsException();
    }
    ...
    public ApplicationException createException(String message) {
        return new JndiNameAlreadyExistsException(message);
    }
    ...
    public ApplicationException createException(Throwable t) {
        return new JndiNameAlreadyExistsException(t);
    }
    ...
    public ApplicationException createException(String message, Throwable t) {
        return new JndiNameAlreadyExistsException(message, t);
    }
