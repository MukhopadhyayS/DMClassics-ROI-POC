 ...
 */
public class TestInvalidCriteriaException extends TestApplicationException {
     ...
     * @param arg0
     */
    public TestInvalidCriteriaException(String arg0) {
        super(arg0);
    }

    public static Test suite() {
        return new CoverageSuite(TestInvalidCriteriaException.class,
                InvalidCriteriaException.class);
    }

    public ApplicationException createException() {
        return new InvalidCriteriaException();
    }
    ...
    public ApplicationException createException(String message) {
        return new InvalidCriteriaException(message);
    }
    ...
    public ApplicationException createException(Throwable t) {
        return new InvalidCriteriaException(t);
    }
    ...
    public ApplicationException createException(String message, Throwable t) {
        return new InvalidCriteriaException(message, t);
    }
