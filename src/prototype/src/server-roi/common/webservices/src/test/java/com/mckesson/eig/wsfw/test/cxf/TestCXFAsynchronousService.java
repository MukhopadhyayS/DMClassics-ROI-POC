 ...
 */
public class TestCXFAsynchronousService extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        super.setUp();
        setupTestQueue();
        File webxml = new File("WEB-INF/testCXFAsyncweb.xml");
    ...
    public void testAsynchronousService() {
        ...
        try {
            ...
            _requestBuilder.setOperationData("createEmployee");
            com.mckesson.eig.wsfw.test.SoapRequestBuilder.Parameter employee = 
                _requestBuilder.addParameter("employee", "");
            employee.addParameter("id", "1");
            employee.addParameter("firstName", "Mck");
            employee.addParameter("lastName", "Inc");
            employee.addParameter("designation", "HE");

            InputStream requestMessage = _requestBuilder.buildSoapRequest();

            WebRequest request = 
                new PostMethodWebRequest("http://hostname.ingored.com/employee.async",
                                          requestMessage, 
                                          "text/xml");
