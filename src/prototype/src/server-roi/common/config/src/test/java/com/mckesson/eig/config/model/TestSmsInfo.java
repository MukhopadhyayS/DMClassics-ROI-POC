 ...
 */
public class TestSmsInfo extends TestCase {

	/**
	 * Holds instance of message.
	 */
	private static final String MESSAGE = "SmsInfo Message";

	/**
	 * Holds instance of fax info to.
	 */
	private static final String TO = "SmsInfo To";
     ...
     * <code>SmsInfo</code>
	 */
	public void testsmsInfoMessage() {

		_smsInfo.setMessage(MESSAGE);
		assertEquals(MESSAGE, _smsInfo.getMessage());
	}
     ...
     * <code>SmsInfo</code>
	 */
	public void testsmsInfoTo() {

		_smsInfo.setTo(TO);
		assertEquals(TO, _smsInfo.getTo());
	}
