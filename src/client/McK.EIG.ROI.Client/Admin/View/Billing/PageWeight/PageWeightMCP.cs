...
namespace McK.EIG.ROI.Client.Admin.View.Billing.PageWeight
{
    ...
    /// </summary>
    public class PageWeightMCP : ROIBasePane, ITransientDataApprover
    {
        #region Fields

        private PageWeightListUI pageWeightUI;
        ...
        /// <summary>
        /// Initilize the view of PageWeightMCPUI.
        /// </summary>
        protected override void InitView()
        {
            pageWeightUI = new PageWeightListUI();
            IsDirty      = false;
        }
        ...
        {
            pageWeightUI.EnableEvents();
        }

        public void DisableEvents()
        {
            pageWeightUI.DisableEvents();
        }
        ...
        public void PrePopulate()
        {
            try
            {
                ...
                PageWeightDetails weightDetails = ROIAdminController.Instance.RetrieveWeight();
                if (weightDetails != null)
                {
                    SetData(weightDetails);
                }
            }
        ...
        public bool Approve(ApplicationEventArgs ae)
        {
            ...
            {
                IsDirty = false;
                if (!((PageWeightListUI)this.View).Save())
                {
                    isDirty = true;
                }
                else
            ...
            {
                ((PageWeightListUI)this.View).CancelPageWeight();
                IsDirty = false;
                return true;
            }
