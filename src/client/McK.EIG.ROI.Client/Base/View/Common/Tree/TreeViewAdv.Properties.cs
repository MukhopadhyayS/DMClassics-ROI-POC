...
using McK.EIG.ROI.Client.Base.View.Common.Tree.Input;
...
namespace McK.EIG.ROI.Client.Base.View.Common.Tree
{
	public partial class TreeViewAdv
	{
		...
		public static bool KeepNodesExpanded
		{
			get { return true; }			
		}
        ...
        private GridlineStyles _gridLineStyle = GridlineStyles.None;
        [DefaultValue(GridlineStyles.None), Category("Appearance")]
        public GridlineStyles GridlineStyle
        {
            get
            {
		...
		private float _topEdgeSensitivity = 0.3f;
		[DefaultValue(0.3f), Category("Behavior")]
		public float TopEdgeSensitivity
		{
			get { return _topEdgeSensitivity; }
			set
			{
				if (value < 0 || value > 1)
					throw new ArgumentOutOfRangeException(string.Empty);
				_topEdgeSensitivity = value;
			}
		}

		private float _bottomEdgeSensitivity = 0.3f;
		[DefaultValue(0.3f), Category("Behavior")]
		public float BottomEdgeSensitivity
		{
			get { return _bottomEdgeSensitivity; }
			set
			{
				if (value < 0 || value > 1)
					throw new ArgumentOutOfRangeException(string.Empty);
				_bottomEdgeSensitivity = value;
			}
		}
		...
		private IToolTipProvider _defaultToolTipProvider;
		[Browsable(false)]
