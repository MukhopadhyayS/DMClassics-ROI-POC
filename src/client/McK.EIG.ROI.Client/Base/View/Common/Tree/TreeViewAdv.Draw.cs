...
namespace McK.EIG.ROI.Client.Base.View.Common.Tree
{
	public partial class TreeViewAdv
	{
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
			...
			if ((GridlineStyle & GridlineStyles.Vertical) == GridlineStyles.Vertical && UseColumns)
		...
		private void DrawRow(PaintEventArgs e, ref DrawContext context, int row, Rectangle rowRect)
		{
            ...
            if ((GridlineStyle & GridlineStyles.Horizontal) == GridlineStyles.Horizontal)
		...
		private void EndPerformanceCount(PaintEventArgs e)
		{
			...
			_totalTime += time;
			string debugText = string.Format(System.Threading.Thread.CurrentThread.CurrentUICulture, "FPS {0:0.0}; Avg. FPS {1:0.0}",
