...
namespace McK.EIG.ROI.Client.Base.View.Common
{
    public partial class LoadingCircle : Control
    {
        ...
        private PresetStyle m_StylePreset;
        ...
        [Category("LoadingCircle"),
         ...
         DefaultValue(typeof(PresetStyle), "Custom")]
        public PresetStyle StylePreset
        {
