...
namespace McK.EIG.ROI.Client.Patient.View.PatientInfo
{
    public partial class PatientInfoActionUI : ROIBaseUI 
    {
        ...
        {
            InitializeComponent();
            deletePatientButton.Image = ROIImages.DeleteButtonIcon;
        }
        ...
        {
            get { return deletePatientButton; }
        }
        ...
        public override void Localize()
        {
            ...
            SetLabel(rm, deletePatientButton);

            rm = Context.CultureManager.GetCulture(CultureType.ToolTip.ToString());
            SetTooltip(rm, toolTip, saveButton);            
            SetTooltip(rm, toolTip, deletePatientButton);
