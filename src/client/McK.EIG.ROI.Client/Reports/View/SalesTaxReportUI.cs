...
{
    /// <summary>
    /// SalesTaxReportUI having the same view as SalesTaxReportUI.
    /// </summary>
    public partial class SalesTaxReportUI : ReportBaseCriteriaUI, IReportCriteria
    {
        #region constructor

        public SalesTaxReportUI()
        {
            ReportBaseCriteriaUI.reportInputFieldisRequired = true;
            InitializeComponent();
        ...
        public void PrePopulate()
        {
            ...
            InputFieldUI.Populate();
            DateRangeUI.Populate();
            base.SearchCriteriaPanel.AutoScroll = true;
            FirstCheckedListUI.Size = new System.Drawing.Size(285, 135);
        ...
        {
            base.Localize();
            FirstCheckedListUI.TitleKey = "salesTaxBillingLocation.Summary.Report";
        ...
        public object GetData(object parameters)
        {
            ...
            criteriaHt.Add(ROIConstants.ReportRequestorName, InputFieldUI.RetrieveFieldValue());
