...
namespace McK.EIG.ROI.Client.App.Reports {
    ...
    public class SalesTaxReport_1 : ReportClass {
        
        public SalesTaxReport_1() {
        }
        
        public override string ResourceName {
            get {
                return "SalesTaxReport_1.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "McK.EIG.ROI.Client.App.Reports.SalesTaxReport_1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSalesTaxReport_1 : Component, ICachedReport {
        
        public CachedSalesTaxReport_1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SalesTaxReport_1 rpt = new SalesTaxReport_1();
            rpt.Site = this.Site;
            return rpt;
        }
