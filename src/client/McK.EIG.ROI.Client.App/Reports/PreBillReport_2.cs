...
namespace McK.EIG.ROI.Client.App.Reports {
    ...
    public class PreBillReport_2 : ReportClass {
        
        public PreBillReport_2() {
        }
        
        public override string ResourceName {
            get {
                return "PreBillReport_2.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "McK.EIG.ROI.Client.App.Reports.PreBillReport_2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPreBillReport_2 : Component, ICachedReport {
        
        public CachedPreBillReport_2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PreBillReport_2 rpt = new PreBillReport_2();
            rpt.Site = this.Site;
            return rpt;
        }
