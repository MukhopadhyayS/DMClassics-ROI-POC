...
ECHO  ------------------------------------------------------------------------
ECHO  --  ROI migration tool script start (Canceled and Denied Requests)    --
ECHO  ------------------------------------------------------------------------
...
ECHO Processing...
sqlcmd -S %serverName% -U %userLoginName% -P %userPassword% -r0 -s"	" -W -i Requests_Canceled_and_Denied.sql -o Requests_Canceled_and_Denied.txt -b
...
:FAILED
ECHO  ------------------------------------------------------------------------
ECHO  --  ROI migration tool script  failed (Canceled and Denied Requests)  --
ECHO  ------------------------------------------------------------------------
GOTO END

:SUCCESS
ECHO  -----------------------------------------------------------------------
ECHO  -- ROI migration tool script succeed (Canceled and Denied Requests)  --
ECHO  -----------------------------------------------------------------------
