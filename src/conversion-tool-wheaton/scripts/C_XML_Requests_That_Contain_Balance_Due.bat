...
ECHO Processing...
sqlcmd -S %serverName% -U %userLoginName% -P %userPassword% -r0 -s"	" -W -i C_XML_Requests_That_Contain_Balance_Due.sql -o C_XML_Requests_That_Contain_Balance_Due.txt -b
