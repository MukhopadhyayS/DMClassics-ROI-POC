 ...
 */
public class RequestStatusSummaryReportDAOImpl
extends ROIReportDAOImpl {


    private static final Log LOG = LogFactory.getLogger(RequestStatusSummaryReportDAOImpl.class);
    ...
    private static final int REQUEST_ID_POSITION = 2;
    ...
    public void generateReport(String reportID, Map params,
        ...
        try {
            ...
            List<Object[]> results = processNamedQuery("ROI_Generate_RequestStatusSummaryReport",
                                                        criterias);
    ...
    private Object[] getCriteria(Map reportParams) throws IOException {
        ...
        final String logSM = "getCriteria(Map reportParams)";
        if (DO_DEBUG) {
            LOG.debug(logSM + ">>Start");
        }
    ...
    private String getHeaders() {
        ...
        return new StringBuffer()
               ...
               .append("Request Id,Request Status, Facility")
       .toString();
    }
}
