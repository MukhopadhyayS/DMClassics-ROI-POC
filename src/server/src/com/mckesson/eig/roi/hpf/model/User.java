...
public class User implements java.io.Serializable {
    ...
    public static final String FREE_FORM_FACILITIES = "freeForm.facilities";
    public static final String USER_FACILITIES = "user.facilities";
    ...
    public Integer getInstanceId() { return (Integer) getIdentity(); }
    ...
    public void setInstanceId(Integer instanceId) { setIdentity(instanceId); }

    public String getLoginId() { return _loginId; }
    public void setLoginId(String id) { _loginId = id; }
    ...
    public String getTrimmedPin() { return StringUtilities.trim(getPin()); }
    public void setPin(String pin) { _pin = pin; }

    protected Boolean getAdministratorAsBoolean() { return _administrator; }
    protected void setAdministratorAsBoolean(Boolean value) { _administrator = value; }

    public void setAdministrator(boolean value) { setAdministratorAsBoolean(new Boolean(value)); }
    ...
    public boolean isRoleEnabled(String roleName) { return (getRoles().indexOf(roleName) != -1);  }

    public boolean validatePin(String pin) {
        return StringUtilities.isEmpty(getPin()) || isPinMatch(pin);
    }

    public int getValidateCode() { return _validateCode; }
    ...
    private boolean isValidInstanceId() { return getInstanceIdValue() > -1; }
    ...
    public boolean getIsPhysician() { return isPhysician(); }
    public boolean isPhysician() { return StringUtilities.trimLength(getPin()) > 0; }

    public Integer getIdle() { return _idle; }
    public Integer getIdleTime() { return (_idle == null) ? new Integer(0) : _idle; }

    public void setIdle(Integer idle) { _idle = idle; }

    public Integer getAccountDisabledAsInteger() { return _accountDisabled; }
    ...
    public boolean allowViewAssignment(String facility) { return true; }
    ...
    public String getSigninAddress() { return _signinAddress; }
    public void setSigninAddress(String signinAddress) { _signinAddress = signinAddress; }

    public String getSigninHost() { return _signinHost; }
    public void setSigninHost(String signinHost) { _signinHost = signinHost; }

    public String getLocation() { return getSigninHost() + " (" + getSigninAddress() + ")"; }
    ...
    public String getTextName() { return _textName; }
    public void setTextName(String string) { _textName = string; }

    public String getTrimmedInitial() { return StringUtilities.safeTrim(getInitial()); }

    public String getInitial() { return _initial; }
    public void setInitial(String string) { _initial = string; }

    public Integer getOverrideRestrictionLevelAsInteger() { return _overrideRestrictionLevel; }
    public void setOverrideRestrictionLevelAsInteger(Integer i) { _overrideRestrictionLevel = i; }

    public Integer getInvalidLogonCountAsInteger() { return _invalidLogonCount; }
    public void setInvalidLogonCountAsInteger(Integer i) { _invalidLogonCount = i; }

    public Integer getChangePasswordAsInteger() { return _changePassword; }
    public void setChangePasswordAsInteger(Integer i) { _changePassword = i; }

    public Integer getRestrictResultsAsInteger() { return _restrictResults; }
    public void setRestrictResultsAsInteger(Integer i) { _restrictResults = i; }

    public String getSubjectId() { return _subjectId; }
    public void setSubjectId(String subjectId) { _subjectId = subjectId; }

    public void setDomainIdAsInteger(Integer i) { _domainId = i; }
    public Integer getDomainIdAsInteger() { return _domainId; }

    public Password getPasswordEncryptor() { return _passwordEncryptor; }

    public boolean hasFullName() { return StringUtilities.hasContent(getFullName()); }
    ...
    private boolean isPinMatch(String pin) { return isEncryptedMatch(getTrimmedPin(), pin); }
    ...
    private boolean equals(String x, String y) { return StringUtilities.equals(x, y); }
    ...
    public String getDisplayName() {
        return StringUtilities.hasContent(getFullName()) ? getTrimmedFullName() : getLoginId();
    }
    ...
    public HashMap<String, HashMap<Integer, Boolean>> getSecurityRightsMap() {
        return _securityRightsMap;
    }

    public HashMap<Integer, Boolean> getSecurityRightsMap(String facility) {
        return _securityRightsMap.get(facility);
    }

    public void setSecurityRightsMap(HashMap<String, HashMap<Integer, Boolean>> rightsMap) {
        _securityRightsMap = rightsMap;
    }

    public List<String> getFacilities() { return _facilities; }
    public void setFacilities(List<String> facilities) { _facilities = facilities; }

    public boolean getEpnEnabled() { return _epnEnabled; }
    public void setEpnEnabled(boolean enabled) { _epnEnabled = enabled; }

    public String getEpnPrefix() { return _epnPrefix; }
    public void setEpnPrefix(String prefix) { _epnPrefix = prefix; }

    public String getRvGroup() { return _rvGroup; }
    public void setRvGroup(String group) { _rvGroup = group; }

    public List<String> getFreeFormFacilities() { return _freeFormFacilities; }
    public void setFreeFormFacilities(List<String> freeForm) { _freeFormFacilities = freeForm; }

    public boolean getMaskSSN() { return _maskSSN; }
    public void setMaskSSN(boolean maskSSN) { _maskSSN = maskSSN; }
    ...
    /**
     * This method will construct a security rights map
     * @param list of security rights
     * @return rightsMap<facility, rightIdsMap<securityId, enabled>>
     */
    public static HashMap<String, HashMap<Integer, Boolean>>
        transferRightsToMap(List<UserSecurity> rights) {

        HashMap<Integer, Boolean> rightIds = new HashMap<Integer, Boolean>();

        for (UserSecurity userSecurity : rights) {

            String facility = userSecurity.getFacility();
            if ((facility != null) && UserSecurity.ENTERPRISE.equalsIgnoreCase(facility.trim())) {
                rightIds.put(Integer.valueOf(userSecurity.getSecurityId()), true);
            }
        }
        HashMap<String, HashMap<Integer, Boolean>> rightMap =
            new HashMap<String, HashMap<Integer, Boolean>>();

        rightMap.put(UserSecurity.ENTERPRISE, rightIds);
        return rightMap;
    }
}
