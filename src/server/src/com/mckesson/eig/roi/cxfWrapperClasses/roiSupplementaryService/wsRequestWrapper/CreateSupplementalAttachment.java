...
@XmlRootElement(name = "createSupplementalAttachment")
public class CreateSupplementalAttachment {

    @XmlElement(required = true)
    protected ROISupplementalAttachment supplementalAttachment;
     ...
     *     
     */
    public ROISupplementalAttachment getSupplementalAttachment() {
     ...
     *     
     */
    public void setSupplementalAttachment(ROISupplementalAttachment value) {
