...
//     */
//    private static final OCLogger LOG = new OCLogger(AuthorizationInterceptor.class);
//
...
//            LOG.info("operationInfo:: " + operationInfo.getInputName());
//            operationName = operationInfo.getInputName();
//        }
//
...
//        OperationInfo operationName = (OperationInfo) exchange.get(OperationInfo.class.getName());
//        if (operationName == null) {
//            return StringUtilities.EMPTYSTRING;
//        }
//        LOG.debug("*** operationName :" + operationName);
//        return operationName.getName().toString();
//    }*/
//}
