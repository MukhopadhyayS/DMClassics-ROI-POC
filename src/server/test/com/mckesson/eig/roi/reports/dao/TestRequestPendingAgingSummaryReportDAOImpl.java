 ...
 */
public class TestRequestPendingAgingSummaryReportDAOImpl
extends BaseROITestCase {
    ...
    /**
     * Test case to generate request pending aging summary report with valid input
     */
    ...
    /**
     * Test case to generate request pending aging summary report with invalid from date
     */
    public void testReportWithInvalidFromDate() {
        ...
        try {
            ...
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Pending Aging Summary Report should have failed");
    ...
    /**
     * Test case to generate request pending aging summary report with from date as null
     */
    public void testReportWithNullFromDate() {

        try {
            String url = constructURLString("Patient", "IE", null, "10/14/2008", "7", "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Pending Aging Summary Report should have failed");
    ...
    /**
     * Test case to generate request pending aging summary report with to date as null
     */
    public void testReportWithNullToDate() {

        try {
            String url = constructURLString("Patient", "IE", "10/14/2008", null, "7", "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Pending Aging Summary Report should have failed");
    ...
    /**
     * Test case to generate request pending aging summary report with invalid report id
     */
    ...
    /**
     * Test case to generate request pending aging summary report without facility
     */
    public void testReportWithoutFacility() {
    ...
    /**
     * Test case to generate request pending aging summary report without from date
     */
    ...
    /**
     * Test case to generate request pending aging summary report without to date
     */
