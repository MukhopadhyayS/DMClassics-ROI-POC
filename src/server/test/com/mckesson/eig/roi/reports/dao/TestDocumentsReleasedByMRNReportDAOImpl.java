 ...
 */
public class TestDocumentsReleasedByMRNReportDAOImpl
extends BaseROITestCase {
    ...
    /**
     * Test case to generate documents by mrn report with valid input
     */
    ...
    /**
     * Test case to generate  documents by mrn report with invalid report id
     */
    public void testReportWithInvalidReportId() {
        ...
        try {
            ...
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate documents by mrn Report should have failed");
    ...
    /**
     * Test case to generate  documents by mrn report without status
     */
    public void testReportWithInvalidUserId() {

        try {
            String url = constructURLStringWithInvalidUserId("IE",
                                                             "ROIM00008",
                                                             "3",
                                                             "100");
            WebRequest request = new GetMethodWebRequest(url);
    ...
    protected String constructURLStringWithInvalidUserId(String facilities,
                                                         String mrn,
                                                         String reportId,
                                                         String userInstanceId) {
