IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[WFE_ROI_ProcessAutomatedRequest]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[WFE_ROI_ProcessAutomatedRequest]
SET ANSI_NULLS ON
GO
...
/***************************************************************************************************************
* Stored Procedure: WFE_ROI_ProcessAutomatedRequest
...
Create PROCEDURE [dbo].[WFE_ROI_ProcessAutomatedRequest](
...
GO
GRANT EXECUTE ON [dbo].[WFE_ROI_ProcessAutomatedRequest] TO [IMNET]
