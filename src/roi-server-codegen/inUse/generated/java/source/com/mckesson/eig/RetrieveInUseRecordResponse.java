...
public class RetrieveInUseRecordResponse {
    ...
    @XmlElementRef(name = "inUseRecord", namespace = "urn:eig.mckesson.com", type = JAXBElement.class, required = false)
    protected JAXBElement<InUseRecord> inUseRecord;
     ...
     *     
     */
    public JAXBElement<InUseRecord> getInUseRecord() {
        return inUseRecord;
    }
     ...
     *     
     */
    public void setInUseRecord(JAXBElement<InUseRecord> value) {
