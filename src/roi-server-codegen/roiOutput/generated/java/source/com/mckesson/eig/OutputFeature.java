...
public class OutputFeature {
    ...
    protected long outputFeatureId;
    @XmlElement(required = true)
    protected String name;
    @XmlElement(required = true)
    protected String description;
    protected List<Map> attributes;

    /**
     * Gets the value of the outputFeatureId property.
     * 
     */
    public long getOutputFeatureId() {
        return outputFeatureId;
    }

    /**
     * Sets the value of the outputFeatureId property.
     * 
     */
    public void setOutputFeatureId(long value) {
        this.outputFeatureId = value;
    }
