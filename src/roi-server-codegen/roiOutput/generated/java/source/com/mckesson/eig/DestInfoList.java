...
public class DestInfoList {
    ...
    protected List<DestInfo> destInfoList;
     ...
     * This is why there is not a <CODE>set</CODE> method for the destInfoList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDestInfoList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<DestInfo> getDestInfoList() {
        if (destInfoList == null) {
            destInfoList = new ArrayList<DestInfo>();
        }
