...
public class SalesTaxSummary {
    ...
    protected List<SalesTaxReason> salesTaxReason;
    ...
    /**
     * Gets the value of the salesTaxReason property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the salesTaxReason property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSalesTaxReason().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<SalesTaxReason> getSalesTaxReason() {
        if (salesTaxReason == null) {
            salesTaxReason = new ArrayList<SalesTaxReason>();
        }
        return this.salesTaxReason;
    }
