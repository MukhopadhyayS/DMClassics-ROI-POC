...
public class RequestPatientsList {
    ...
    protected List<RequestPatient> requestPatients;
    ...
    /**
     * Gets the value of the requestPatients property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the requestPatients property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRequestPatients().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RequestPatient> getRequestPatients() {
        if (requestPatients == null) {
            requestPatients = new ArrayList<RequestPatient>();
        }
