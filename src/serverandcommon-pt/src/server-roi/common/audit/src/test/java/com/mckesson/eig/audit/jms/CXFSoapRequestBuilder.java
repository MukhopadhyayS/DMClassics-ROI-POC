 ...
 */
public class CXFSoapRequestBuilder {
     ...
     */
    public CXFSoapRequestBuilder(String serviceURI) {
    ...
    throws SOAPException {
        ...
        SOAPElement transIdElement = message.getSOAPHeader().addChildElement(
                headerName, "eig", EIGConstants.TYPE_NS_V1);
    ...
    private SOAPMessage createSoapMessage() throws SOAPException {
        ...
        SOAPBodyElement bodyElement = bdy.addBodyElement(env.createName(_operation));
