...
public class AuthenticationFilter implements Filter {
    ...
    private static final OCLogger LOG = new OCLogger(AuthenticationFilter.class);
    /**
    ...
    throws IOException, ServletException {
        ...
        try {
            ...
            httpRes.sendError(HttpServletResponse.SC_BAD_REQUEST, htmlCustomCodec.encode(e.getMessage()));
        }
    }
