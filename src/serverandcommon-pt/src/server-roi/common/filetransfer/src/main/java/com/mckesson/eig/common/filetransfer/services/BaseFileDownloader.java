...
public class BaseFileDownloader extends HttpServlet implements IDownloadContent {
    ...
    private static final OCLogger LOG = new OCLogger(BaseFileDownloader.class);
    ...
    throws IOException {
        ...
        try {
            ...
            servData.getResponse().setStatus(Integer.parseInt(
            		htmlCustomCodec.encode(String.valueOf(HttpServletResponse.SC_BAD_REQUEST))));
            servData.getResponse().sendError(HttpServletResponse.SC_BAD_REQUEST,
            		htmlCustomCodec.encode("An I/O error occurred for the provided file id= " + servData.getFileID()
