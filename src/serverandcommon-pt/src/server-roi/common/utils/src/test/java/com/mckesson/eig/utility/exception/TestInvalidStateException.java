 ...
 */
public class TestInvalidStateException extends TestApplicationException {
     ...
     * @param arg0
     */
    public TestInvalidStateException(String arg0) {
        super(arg0);
    }

    public static Test suite() {
        return new CoverageSuite(TestInvalidStateException.class,
    ...
    public ApplicationException createException(Throwable t) {
        return new InvalidStateException(t);
    }
    ...
    public ApplicationException createException(String message, Throwable t) {
        return new InvalidStateException(message, t);
    }
