...
public class TestClassNames extends TestCase {
    ...
    public TestClassNames(String name) {
        super(name);
    }

    public static Test suite() {
        return new CoverageSuite(TestClassNames.class, ClassNames.class);
    }

    public void testNames() {
        ClassNames names = new ClassNames();
        assertEquals("netscape.javascript.JSObject", names.forJavaScriptCalls());
    }
}
