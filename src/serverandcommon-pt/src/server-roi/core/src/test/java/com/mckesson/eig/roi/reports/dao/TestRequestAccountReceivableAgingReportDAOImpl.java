 ...
 */
public class TestRequestAccountReceivableAgingReportDAOImpl
extends BaseROITestCase {
    ...
    /**
     * Test case to generate account receivable aging report with from date as null
     */
    public void testReportWithNullFromDate() {

        try {
            String url = constructURLString("Patient", "IE", null, "10/14/2008", "2", "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Account Receivable Aging Report should have failed");
    ...
    /**
     * Test case to generate account receivable aging report with to date as null
     */
    public void testReportWithNullToDate() {

        try {
            String url = constructURLString("Patient", "IE", "10/14/2008", null, "2", "1");
            WebRequest request = new GetMethodWebRequest(url);
            WebResponse response = _servletUntClient.sendRequest(request);
            fail("Generate Account Receivable Aging Report should have failed");
    ...
    /**
     * Test case to generate account receivable aging report with invalid report id
     */
    ...
    /**
     * Test case to generate account receivable aging report without status
     */
    ...
    /**
     * Test case to generate account receivable aging report without from date
     */
