 ...
 * functionality.
 */
public class TestAsyncResumeProcessInstance extends AbstractWorkflowTestCase {

    private static final int APP_ID = 1;
    private static final int ET_DOMAIN = 1;
    private static final long PROCESS_INSTANCE_ID = 1151;
    ...
    public void testResumeProcessInstance() {
        ...
        final String operation = "testAsyncResumeProcessInstance";
        ...
        try {
            ...
            service.resumeProcessInstance(_userActor, _aclActors, PROCESS_INSTANCE_ID);
        } catch (Exception e) {

            fail("Exception excecuting resume operation on asynchronous process instance service:"
                                    + PROCESS_INSTANCE_ID);
        } finally {
