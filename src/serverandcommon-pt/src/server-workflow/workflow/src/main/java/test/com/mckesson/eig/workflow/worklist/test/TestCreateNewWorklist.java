...
public class TestCreateNewWorklist
extends com.mckesson.eig.workflow.test.AbstractWorkflowTestCase {
     ...
     */
    public void testCreateNewWorklist() {
       ...
       _worklist = _manager.createNewWorklist(wl);
       assertNotNull(_worklist);
       assertTrue(_worklist.getWorklistID() > 0);
       log("created");
   }
     ...
     */
    public void testValidCharactersForNewWorklist() {
        ...
        while (currentIndex < validDataLength) {
            ...
            deleteIds[0] = _worklist.getWorklistID();
    ...
    */
   public void testCreateNewWorklistWithSameName() {
    ...
    */
   public void testCreateNewWorklistWithSameNameWithDiffOwner() {
    ...
    * same owner.
    */
   public void testCreateNewWorklistWithSameNameAndDifferentCase() {
    ...
    * specifying a name.
    */
   public void testCreateNewWorklistWithoutName() {
    ...
    * a description.
    */
   public void testCreateNewWorklistWithoutDesc() {
...
public void testCreateNewWorklistWithoutOwners() {
    ...
    */
   public void testCreateNewWorklistWithInvalidNameLength() {
    ...
    */
   public void testCreateNewWorklistWithInvalidDescLength() {
    ...
    */
   public void testCreateNewWorklistWithNullWorklist() {
