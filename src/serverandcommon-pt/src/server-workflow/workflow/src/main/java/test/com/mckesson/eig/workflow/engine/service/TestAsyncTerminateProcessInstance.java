 ...
 * functionality.
 */
public class TestAsyncTerminateProcessInstance extends AbstractWorkflowTestCase {
    ...
    public void testTerminateProcessInstance() {
        ...
        final String operation = "testAsyncTerminateProcessInstance";
        ...
        try {
            ...
            service.terminateProcessInstance(_userActor, _aclActors, PROCESS_INSTANCE_ID);
        } catch (Exception e) {

           fail("Exception excecuting terminate operation on asynchronous process instance service:"
                                    + PROCESS_INSTANCE_ID);
        } finally {
