...
public class TestPlainQueryProcessInstanceStart extends AbstractWorkflowTestCase {
    ...
    public void testPlainQueryProcessDefinition() {
        ...
        ProcessDefinition processDefinition = ProcessDefinition
                .parseXmlResource("com/mckesson/eig/workflow/engine/api/database"
                        + "/processdefinition/testplainquery/processdefinition.xml");
