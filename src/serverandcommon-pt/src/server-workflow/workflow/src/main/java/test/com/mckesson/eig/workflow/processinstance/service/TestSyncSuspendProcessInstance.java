 ...
 * functionality.
 */
public class TestSyncSuspendProcessInstance extends AbstractWorkflowTestCase {
    ...
    public void testSuspendProcessInstance() {
        ...
        final String operation = "testSyncSuspendProcessInstance";
        ...
        try {
            ...
            fail("Exception excecuting suspend operation on synchronous process instance:"
                                    + PROCESS_INSTANCE_ID);
        } finally {
