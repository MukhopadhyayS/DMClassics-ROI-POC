 ...
 *
 */
public class TestActionHandlerAttributeList extends TestCase {
    ...
    public void testConstructors() {
        ...
        assertNotNull(ahaList);
        assertTrue(ahaList.getActionHandlerAttributeList().size() == 0);
        
        List<ActionHandlerAttribute> aList = new ArrayList<ActionHandlerAttribute>();
        ahaList = new ActionHandlerAttributeList(aList);
        assertNotNull(ahaList.getActionHandlerAttributeList());
        assertTrue(ahaList.getActionHandlerAttributeList().size() == 0);
    }
...
*/
        ...
        List<ActionHandlerAttribute> aList = new ArrayList<ActionHandlerAttribute>();
        ActionHandlerAttribute actionHandlerAttribute = new ActionHandlerAttribute();
        aList.add(actionHandlerAttribute);
        
        ahaList.setActionHandlerAttributeList(aList);
        ahaList.setSize(1);

        assertNotNull(ahaList.getActionHandlerAttributeList());
        assertTrue(ahaList.getActionHandlerAttributeList().size() == 1);
    }
    ...
    public void testToString() {
        ...
        List<ActionHandlerAttribute> aList = 
            new ArrayList<ActionHandlerAttribute>();
        aList.add(actionHandlerAttribute);
        
        ahaList.setActionHandlerAttributeList(aList);
        ahaList.setSize(1);
        
        assertEquals("ActionHandlerAttributeList[ ActionHandlerAttribute[actionHandlerName="
                + "ActionHandlerName, attributeName=AttributeName, attributeDefaultValue="
                + "AttributeDefaultValue, attributeType=AttributeType, "
