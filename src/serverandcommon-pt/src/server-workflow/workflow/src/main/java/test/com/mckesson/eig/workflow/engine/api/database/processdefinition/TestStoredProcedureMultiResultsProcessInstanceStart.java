...
/**
 * Unit test class for testing ProcessInstanceEngineImpl start instance functionality.
 */
public class TestStoredProcedureMultiResultsProcessInstanceStart extends AbstractWorkflowTestCase {
    ...
    public void testStoredProcedureProcessDefinition() {
        ...
        ProcessDefinition processDefinition = ProcessDefinition
                .parseXmlResource("com/mckesson/eig/workflow/engine/api/database"
                        + "/processdefinition/teststoredproceduremultiresults"
