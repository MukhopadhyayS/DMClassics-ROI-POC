 ...
 * @since  HECM 1.0
 */
public class TestGetAssignedTasksCount
extends com.mckesson.eig.workflow.test.AbstractWorkflowTestCase {
   ...
   private void resolveTaskAclsByActors() {
    ...
    /**
    * This method is used to test get assigned worklist tasks count.
    */
    public void testGetAssignedWorklistTasks() {

      long count = _taskService.getAssignedTasksCount(_assignedTaskCriteria);
    ...
    public void testGetAssignedWorklistTaskswithNonExistingWorklistID() {
        ...
        try {
            _taskService.getAssignedTasksCount(assignedTasksCriteria);
    ...
    public void testGetAssignedWorklistTaskswithNonExistingStatusID() {
        ...
        long count = _taskService.getAssignedTasksCount(assignedTasksCriteria);
