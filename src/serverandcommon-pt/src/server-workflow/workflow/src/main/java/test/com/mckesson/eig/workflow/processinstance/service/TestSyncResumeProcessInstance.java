 ...
 * functionality.
 */
public class TestSyncResumeProcessInstance extends AbstractWorkflowTestCase {
    ...
    public void testResumeProcessInstance() {
        ...
        final String operation = "testSyncResumeProcessInstance";
        ...
        try {
            ...
            fail("Exception excecuting resume operation on synchronous process instance:"
                                    + PROCESS_INSTANCE_ID);
        } finally {
