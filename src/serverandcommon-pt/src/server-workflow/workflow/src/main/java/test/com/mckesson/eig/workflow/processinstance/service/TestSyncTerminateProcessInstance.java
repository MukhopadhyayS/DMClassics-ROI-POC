 ...
 * functionality.
 */
public class TestSyncTerminateProcessInstance extends AbstractWorkflowTestCase {
    ...
    public void testTerminateProcessInstance() {
        ...
        final String operation = "testSyncTerminateProcessInstance";
        ...
        try {
            ...
            fail("Exception excecuting terminate operation on synchronous process instance:"
                                    + PROCESS_INSTANCE_ID);
        } finally {
