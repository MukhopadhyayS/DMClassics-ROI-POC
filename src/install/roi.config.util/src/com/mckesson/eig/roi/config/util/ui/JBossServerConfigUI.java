...
import com.mckesson.eig.roi.config.util.controller.JBossServerConfigControllerImpl;
 ...
 */
public class JBossServerConfigUI
extends AbstractConfigUI {
    ...
    private static final Logger LOG = Logger.getLogger(JBossServerConfigUI.class);
    ...
    public void constructObjectDetailsPanel() {
        ...
        String title = (ConfigProps.ROI_SERVER_INSTALLED)
                           ? "roi.jboss.server"
                           : "output.jboss.server";
        ...
        c.gridx = 1;
        c.gridy = 0;
        _portNo = createFormattedTextField(ConfigUtilMessages.getMessage("roi.jboss.serverport"));
    ...
    public void prepopulate() {
      ...
      try {
          ...
          LOG.debug(logSM + "<<End: Existing JBoss Config Details :" + configDetails(configParams));
    ...
    public Object mapConfigParams() {
        ...
        try {
            ...
            LOG.debug(logSM + "<<End: New JBoss Config Details : " + configDetails(configParams));
    ...
    public void initialize() {
        ...
        setController(new JBossServerConfigControllerImpl());
        setValidator(new ConfigurationValidatorImpl());
    }

    /**
     * This method is to generate the string with Jboss configuration details
     * @param configParams jboss config details
     * @return jboss Configuration details
     */
