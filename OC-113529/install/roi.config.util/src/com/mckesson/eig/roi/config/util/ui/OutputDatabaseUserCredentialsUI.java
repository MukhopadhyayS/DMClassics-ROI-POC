...
import com.mckesson.eig.roi.config.util.controller.OutputDBCredentialControllerImpl;
 ...
 * @date   Feb 13, 2013
 */
public class OutputDatabaseUserCredentialsUI
extends AbstractConfigUI {

    private JTextField _userId;
    private JTextField _password;

    private static final Logger LOG = Logger.getLogger(OutputDatabaseUserCredentialsUI.class);
	...
	public void constructObjectDetailsPanel() {
        ...
        getObjectDetailsPanel().setBorder(createTitledBorder(ConfigUtilMessages.
                                                      getMessage("output.database.configuration")));
    ...
    public static void main(String[] args) {
    	new OutputDatabaseUserCredentialsUI().constructAndShowUI();
    }
    ...
    public void initialize() {
        setController(new OutputDBCredentialControllerImpl());
    }
