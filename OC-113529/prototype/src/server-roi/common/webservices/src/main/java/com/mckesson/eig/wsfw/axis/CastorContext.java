...
public class CastorContext {
     ...
     */
    private static final Log LOG = LogFactory.getLogger(CastorContext.class);
    ...
    throws MappingException {
        ...
        MappingLoader loader = mappingUnmarshaller.getMappingLoader(_mapping, BindingType.XML);
        InternalContext context = ((XMLMappingLoader)loader).getInternalContext();
        
        try {
        	_cldResolver.setInternalContext(context);
	        _cldResolver.setMappingLoader(mappingUnmarshaller.getMappingLoader(_mapping, BindingType.XML));
        } catch (NullPointerException e) {
//        	_cldResolver.setInternalContext(xmlContext);
//        	mappingUnmarshaller.getInternalContext().getXMLClassDescriptorResolver().setInternalContext(unmarshaller.getInternalContext());
//        	idreq = (Root) unmarshaller.unmarshal(inputSource);       	
        }
    }
