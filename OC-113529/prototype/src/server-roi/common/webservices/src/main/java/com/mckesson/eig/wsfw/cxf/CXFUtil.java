...
public final class CXFUtil {
    ...
    private static final Log LOG = LogFactory.getLogger(CXFUtil.class);
    ...
    public static void prepareRequest(Message message) {
        ...
        WsSession.initializeSession(getHttpSession(message));
    ...
    public static void setHeaderValuesInSession(Message message) {
        ...
        WsSession.setSessionData(WsSession.MESSAGE_TIMESTAMP, getTimeStamp((SoapMessage) message));
        WsSession.setSessionData(WsSession.TXN_ID, getEigSoapHeader(message,  WsSession.TXN_ID));
        WsSession.setSessionData(WsSession.APP_ID, getEigSoapHeader(message,  WsSession.APP_ID));
        WsSession.setSessionData(WsSession.SECURITY_HEADER_MAP, 
