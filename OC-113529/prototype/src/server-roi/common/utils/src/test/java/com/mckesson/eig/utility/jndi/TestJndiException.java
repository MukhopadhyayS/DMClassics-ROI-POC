 ...
 * 
 */
public class TestJndiException extends TestApplicationException {
    /**
     * Constructor for ConfigurationExceptionTest.
     * 
     * @param arg0
     */
    public TestJndiException(String arg0) {
        super(arg0);
    }

    public static Test suite() {
        return new CoverageSuite(TestJndiException.class, JndiException.class);
    }

    public ApplicationException createException() {
        return new JndiException();
    }
    ...
    public ApplicationException createException(String message) {
        return new JndiException(message);
    }
    ...
    public ApplicationException createException(String message, Throwable t) {
        return new JndiException(message, t);
    }
