...
public class BillingReportDAOImpl extends ROIReportDAOImpl {
    ...
    private List<Object[]> retrieveAccountDetails(
        ...
        try {
           ...
           // queryValue.setParameterList("names", accountNames);
            ...
            queryValue.addScalar("name", StandardBasicTypes.STRING);
            queryValue.addScalar("amount", StandardBasicTypes.DOUBLE);
            queryValue.addScalar("ledgerSeq", StandardBasicTypes.LONG);
    ...
    private List<String> retrieveAccountNames() {
        try {
            ...
            query.addScalar("balance", StandardBasicTypes.LONG);
            query.addScalar("id", StandardBasicTypes.LONG);
            query.addScalar("code", StandardBasicTypes.STRING);
            query.addScalar("name", StandardBasicTypes.STRING);
            query.addScalar("liquidityOrder", StandardBasicTypes.LONG);
