...
namespace McK.EIG.ROI.Client.App.Reports {
    ...
    public class PreBillReport_1 : ReportClass {
        
        public PreBillReport_1() {
        }
        
        public override string ResourceName {
            get {
                return "PreBillReport_1.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "McK.EIG.ROI.Client.App.Reports.PreBillReport_1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPreBillReport_1 : Component, ICachedReport {
        
        public CachedPreBillReport_1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PreBillReport_1 rpt = new PreBillReport_1();
            rpt.Site = this.Site;
            return rpt;
        }
