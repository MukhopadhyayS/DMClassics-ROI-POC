...
namespace McK.EIG.ROI.Client.Request.View.Comments
{
    ...
    /// </summary>
    public class RequestCommentEditor : ROIEditor
    {
        #region Fields
        ...
        public override void PrePopulate()
        {
            try
            {
                ...
                requestCommentODP.PrePopulate(commentDetails);
            }
        ...
        {
            get { return "requestcomment.header.title"; }
        }
        ...
        {
            get { return "requestcomment.header.info"; }
        }
        ...
        {
            get { return typeof(RequestCommentMCP); }
        }
        ...
        {
            get { return typeof(RequestCommentODP); }
        }
