...
namespace McK.EIG.ROI.Client.Base.View.Common.Tree
{
	...
	public class NumericTextBox : TextBox
	{
		...
		private bool invalidNumeric(char key)
		{
			...
			NumberFormatInfo numberFormatInfo = System.Threading.Thread.CurrentThread.CurrentUICulture.NumberFormat;
		...
		public int IntValue
		{
			...
			{
				int intValue;
				Int32.TryParse(this.Text, numberStyle, System.Threading.Thread.CurrentThread.CurrentUICulture.NumberFormat, out intValue);
				return intValue;
			}
		}
		...
		public decimal DecimalValue
		{
			get
			{
				...
				Decimal.TryParse(this.Text, numberStyle, System.Threading.Thread.CurrentThread.CurrentUICulture.NumberFormat, out decimalValue);
				return decimalValue;
			}
		}
