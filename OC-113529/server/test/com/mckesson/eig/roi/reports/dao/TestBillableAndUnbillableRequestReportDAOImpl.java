...
*/
public class TestBillableAndUnbillableRequestReportDAOImpl 
extends BaseROITestCase {
    ...
    private static final String REPORT_ID = "16";
    ...
    /**
     * Test case to generate logged status report without request type
     */
    public void testReportWithoutRequestType() {
        ...
        try {
            ...
            SimpleDateFormat dateFormat = new SimpleDateFormat("MM/dd/yyyy");
            dateFormat.setCalendar(cal);
            String url = constructURLWithoutRequestType("A,AD",
                                                      "Attorney",
                                                      "01/01/2013",
                                                      dateFormat.format(cal.getTime()).toString(),
                                                      "1");
    ...
    protected String constructURLWithoutRequestType(String facilities,
                                                    String requestorTypes,
                                                    String fromDate,
                                                    String toDate,
                                                    String userInstanceId
