...
namespace McK.EIG.ROI.Client.App.Reports {
    ...
    public class PreBillReport_0 : ReportClass {
        
        public PreBillReport_0() {
        }
        
        public override string ResourceName {
            get {
                return "PreBillReport_0.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "McK.EIG.ROI.Client.App.Reports.PreBillReport_0.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPreBillReport_0 : Component, ICachedReport {
        
        public CachedPreBillReport_0() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PreBillReport_0 rpt = new PreBillReport_0();
            rpt.Site = this.Site;
            return rpt;
        }
