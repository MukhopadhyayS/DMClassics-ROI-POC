...
{
    /// <summary>
    /// RequestDetailsSorter
    /// </summary>
    public class RequestDetailsSorter : IReportSorter
    {
        #region Fields
        ...
        public Hashtable PrepareParams(ObjectInfo info, int filterIndex, string reportName)
        {
            ...
            if (string.Equals(infoText, ROIConstants.RequestStatus, StringComparison.CurrentCultureIgnoreCase))
            {
                return SortFields(4);
            }
            if (string.Equals(infoText, ROIConstants.StatusDate, StringComparison.CurrentCultureIgnoreCase))
            {
                return SortFields(5);
            }            
            return null;
        ...
        private Hashtable SortFields(int column)
        {
            ...
            switch (column)
            {
                ...
                case 4: requestStatus = ROIConstants.RequestStatus; break;
                case 5: statusDate    = ROIConstants.StatusDate;    break;                            
            }
            ...
            crystalReportHt.Add(ROIConstants.RequestStatusFormula, requestStatus);
            crystalReportHt.Add(ROIConstants.StatusDateFormula,    statusDate);            
