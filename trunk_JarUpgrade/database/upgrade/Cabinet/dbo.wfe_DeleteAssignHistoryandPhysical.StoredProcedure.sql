...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[wfe_DeleteAssignHistoryandPhysical]') AND type in (N'P'))
DROP PROCEDURE [dbo].[wfe_DeleteAssignHistoryandPhysical]
GO

/************************************************************************************************************************
* Stored Procedure	: dbo.wfe_DeleteAssignHistoryandPhysical
...
CREATE    PROCEDURE [dbo].[wfe_DeleteAssignHistoryandPhysical]  (
...
-- Custom Code Begins
	...
	If exists (select 1 from cabinet..assignments a with (nolock)
		   where a.userid = 'HIM: Missing Hist and Phys Dictation Queue'
	...
	Begin
		   ...
		   where userid = 'HIM: Missing Hist and Phys Dictation Queue'
		   ...
		   INSERT INTO [AssignmentAuditEvent]
            ...
            VALUES
                  ...
                  GETDATE(), '1', 'sp_wfe_DeleteAssignHistoryandPhysical', (select PURPOSE from ASSIGNMENTS where ASSIGNMENT_ID=@Assignment_Id));
...
GRANT EXECUTE ON [dbo].[wfe_DeleteAssignHistoryandPhysical] TO [IMNET] AS [dbo]
GO
