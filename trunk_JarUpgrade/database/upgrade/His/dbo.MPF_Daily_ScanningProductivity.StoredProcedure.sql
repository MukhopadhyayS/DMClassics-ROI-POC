...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[MPF_Daily_ScanningProductivity]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[MPF_Daily_ScanningProductivity]
GO
...
* 	have been supplied.
*****************************************************************
*	Procedure Name: [MPF_Daily_ScanningProductivity]
*	Description:	UC5817 - View Daily Scanning Productivity Measure
*	
*	NOTES: 
*   ========================================================================================================================================================================			
...
*	pgs_scanned								HIS			user_productivity		Scanned Pages						ScannedPages
*	scan_time								HIS			user_productivity		Scanned Time						ScannedTime
*	========================================================================================================================================================================
*
*	Revision History:
*	Name					Date			Changes
...
CREATE PROCEDURE [dbo].MPF_Daily_ScanningProductivity
...
SET  @sqlcmd = 'del ' + @HBI_TargetDir + '\MPF_Daily_ScanningProductivity.txt'
EXEC @Success =  master..xp_cmdshell @sqlcmd, NO_OUTPUT

IF OBJECT_ID('tempdb..##MPF_DAILY_SCANNING_PROD_SUBSET') is not null
DROP TABLE ##MPF_DAILY_SCANNING_PROD_SUBSET
...
productivity.pgs_scanned as ScannedPages,
productivity.scan_time as ScannedTime
INTO ##MPF_DAILY_SCANNING_PROD_SUBSET
...
SET  @sqlcmd = ' bcp ##MPF_DAILY_SCANNING_PROD_SUBSET out ' + rtrim(@HBI_TargetDir) + '\MPF_Daily_ScanningProductivity.txt -c -T -S' + @@SERVERNAME

EXEC @Success =  master..xp_cmdshell @sqlcmd --, NO_OUTPUT


IF @Success = 1
	RAISERROR ('bcp of ##MPF_DAILY_SCANNING_PROD_SUBSET was not successful', 10, 1)
...
GRANT EXECUTE ON [dbo].[MPF_Daily_ScanningProductivity] TO [IMNET] AS [dbo]
GO
