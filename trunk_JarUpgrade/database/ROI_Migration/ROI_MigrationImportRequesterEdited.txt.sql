...
* MD Meersma	09/30/2010 Use txt (tab delimited) file to import instead of XLS file
*
...
*
*2) Before executing Migration Step Menu#3 Import Requesters you must save the XLS file from Excel as a TXT file in the c:\imnet\ROI_Migration folder
*
...
Print 'Importing edited Requesters.  Processing file ROI_RequesterEdited' + @l_charNumberOfImportFiles + '.txt.'
...
FROM ''C:\imnet\ROI_Migration\ROI_RequesterEdited' + @l_charNumberOfImportFiles + '.txt''
WITH 
(
FIRSTROW=2,
MAXERRORS=10000,
