...
import com.mckesson.eig.roi.config.util.controller.ClientInstallerConfigControllerImpl;
 ...
 */
public class ClientInstallerConfigUI
extends AbstractConfigUI {
    ...
    private static final Logger LOG = Logger.getLogger(ClientInstallerConfigUI.class);
	...
	public void constructObjectDetailsPanel() {
        ...
        getObjDetailsInnerPanel().add(createFormattedLabel(ConfigUtilMessages.
                                                           getMessage("roi.servername.ipaddress")),
                                                           c);

        c.gridx = 1;
        c.gridy = 0;
        _ipAddress = createFormattedTextField(ConfigUtilMessages.getMessage("roi.server"));
        ...
        c.gridx = 1;
        c.gridy = 1;
        _portNo = createFormattedTextField(ConfigUtilMessages.getMessage("roi.port"));
    ...
    public static void main(String[] args) {
    	new ClientInstallerConfigUI().constructAndShowUI();
    }
    ...
    public Map<String, String> mapConfigParams() {
        ...
        final String logSM = "mapClientConfigParams()";
        LOG.debug(logSM + ">>Start:");
        ...
        try {
            ...
            LOG.debug(logSM + "<<End:New Client Config Details: " + configDetails(configParams));
    ...
    public void initialize() {
        setController(new ClientInstallerConfigControllerImpl());
    }
