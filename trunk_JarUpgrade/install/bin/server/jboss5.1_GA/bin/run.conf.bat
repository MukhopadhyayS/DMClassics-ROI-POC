...
rem #
rem set "JAVA_HOME=C:\Java\jdk1.5.0_16"
...
set JAVA_OPTS=%JAVA_OPTS% -Xms256m -Xmx3072m -XX:MaxPermSize=256m -XX:+UseConcMarkSweepGC
...
rem # Added not to create new session.
