...
//		query.executeUpdate();
	...
	public static Query getRequestMainSP(Session session) {
		...
		String wheatonPreBill = session.getNamedQuery("ROI_Conversion_RequestMain_SP_WheatonPrebillXMLConversion").getQueryString();
		wheatonPreBill = Matcher.quoteReplacement(wheatonPreBill);
		requestSP = requestSP.replaceAll("####ROI_Conversion_RequestMain_SP_WheatonPrebillXMLConversion####", wheatonPreBill);
