  ...
  //This method updates the Requestor details
    public void updateRequestor(Session session, RequestorCore requestor, long requestId) {
        ...
        try {
            ...
            query.setParameter("requestorSeq", requestor.getRequestorSeq(), StandardBasicTypes.LONG);
            query.setParameter("requestorType", requestor.getRequestorType(), StandardBasicTypes.LONG);
            query.setParameter("requestorTypeName", requestor.getRequestorTypeName(),
                                                    StandardBasicTypes.STRING);
            query.setParameter("workPhone", requestor.getWorkPhone(), StandardBasicTypes.STRING);
            query.setParameter("homePhone", requestor.getHomePhone(), StandardBasicTypes.STRING);
            query.setParameter("cellPhone", requestor.getCellPhone(), StandardBasicTypes.STRING);
            query.setParameter("contactName", requestor.getContactName(), StandardBasicTypes.STRING);
            query.setParameter("contactPhone", requestor.getContactPhone(), StandardBasicTypes.STRING);
            query.setParameter("fax", requestor.getFax(), StandardBasicTypes.STRING);
            query.setParameter("firstName", requestor.getFirstName(), StandardBasicTypes.STRING);
            query.setParameter("middleName", requestor.getMiddleName(), StandardBasicTypes.STRING);
            query.setParameter("lastName", requestor.getLastName(), StandardBasicTypes.STRING);
            query.setParameter("suffix", null, StandardBasicTypes.STRING);
            query.setParameter("modifiedDt", requestor.getModifiedDate(), StandardBasicTypes.TIMESTAMP);
            query.setParameter("modifiedSeq", requestor.getModifiedBy(), StandardBasicTypes.INTEGER);
