...
extends ROIReportDAOImpl {
    ...
    public void generateReport(String reportID, Map params,
        ...
        try {
            ...
            facilities = Arrays.asList(ROIReportUtil.convertASCIIValues(facilities.toArray(new String[facilities.size()])));
            ...
            query.addScalar("requestId", StandardBasicTypes.INTEGER);
            query.addScalar("billable", StandardBasicTypes.STRING);
            query.addScalar("requestCost", StandardBasicTypes.DOUBLE);
            query.addScalar("totalPages", StandardBasicTypes.INTEGER);
            query.addScalar("patientName", StandardBasicTypes.STRING);
            query.addScalar("patientMRN", StandardBasicTypes.STRING);
