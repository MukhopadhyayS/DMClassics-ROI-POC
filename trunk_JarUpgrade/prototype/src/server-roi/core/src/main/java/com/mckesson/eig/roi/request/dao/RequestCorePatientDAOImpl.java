...
public class RequestCorePatientDAOImpl
    ...
    private static final Log LOG = LogFactory
            .getLogger(RequestCorePatientDAOImpl.class);
    ...
    public List<RequestPatient> retrieveAllPatientForRequest(long requestId) {
        ...
        try {
            ...
            sqlQuery.addScalar("hpf", StandardBasicTypes.BOOLEAN);
    ...
    public List<RequestPatient> retrieveAllInvoicePatientsByInvoiceIds(
        ...
        try {
            ...
            sqlQuery.addScalar("requestId", StandardBasicTypes.LONG);
            sqlQuery.addScalar("supplementalId", StandardBasicTypes.LONG);
            sqlQuery.addScalar("invoiceId", StandardBasicTypes.LONG);
            sqlQuery.addScalar("mrn", StandardBasicTypes.STRING);
            sqlQuery.addScalar("facility", StandardBasicTypes.STRING);
            sqlQuery.addScalar("name", StandardBasicTypes.STRING);
            sqlQuery.addScalar("gender", StandardBasicTypes.STRING);
            ...
            sqlQuery.setParameterList("invoiceIds", invoiceIds, StandardBasicTypes.LONG);
            sqlQuery.setResultTransformer(Transformers
                    .aliasToBean(RequestPatient.class));
            ...
            List<Long> patientIds)
    {
        ...
        try
        {
            ...
            sqlQuery.setParameterList("patientId", patientIds, StandardBasicTypes.LONG);
