...
implements FeeTypeDAO {
    ...
    private static final Log LOG = LogFactory.getLogger(FeeTypeDAOImpl.class);
    ...
    public FeeTypesList retrieveAllFeeTypesByRequestorId(long requestorTypeId) {
        ...
        try {
            ...
            sqlQuery.addScalar("chargeAmount", StandardBasicTypes.DOUBLE);
            ...
            sqlQuery.addScalar("salesTax", StandardBasicTypes.CHARACTER);
    ...
    public List<RelatedFeeType> retrieveAllRelatedFeeByRequestorType(long requestorTypeId) {
        ...
        sqlQuery.addScalar("id", StandardBasicTypes.LONG);
        sqlQuery.addScalar("billingTemplateId", StandardBasicTypes.LONG);
        sqlQuery.addScalar("feeTypeId", StandardBasicTypes.LONG);
        sqlQuery.addScalar("createdBy", StandardBasicTypes.LONG);
        sqlQuery.addScalar("modifiedDate", StandardBasicTypes.TIMESTAMP);
        sqlQuery.addScalar("modifiedBy", StandardBasicTypes.LONG);
        sqlQuery.addScalar("recordVersion", StandardBasicTypes.INTEGER);
