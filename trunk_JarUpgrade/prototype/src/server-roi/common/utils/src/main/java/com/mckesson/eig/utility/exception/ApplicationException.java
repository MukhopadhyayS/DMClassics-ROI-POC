...
public class ApplicationException extends ChainedException
	...
	private transient Log _log = LogFactory.getLogger(getClass());
    ...
    public RuntimeException log(Log logImpl, Object message) {
        Log logToUse = ((logImpl == null) ? _log : logImpl);
    ...
    private RuntimeException doLog(Log logImpl, Object message) {
        // Since we log automatically in some cases, try to avoid duplicate
        // log entries.
        if (!_logged) {
            logImpl.error(message, this);
            _logged = true;
    ...
    private void readObject(ObjectInputStream in) throws IOException,
        ...
        _log = LogFactory.getLogger(getClass());
